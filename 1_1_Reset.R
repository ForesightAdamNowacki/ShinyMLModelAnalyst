...
shiny::observeEvent(eventExpr = input$actionButton_1_1, handlerExpr = {shiny::updateSelectInput(session, inputId = "selectInput_1_1_2_4", choices = factor_variables_1_1(), selected = factor_variables_1_1()[[1]])})
