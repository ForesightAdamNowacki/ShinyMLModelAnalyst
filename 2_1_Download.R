...
output$downloadButton_2_1_2_1 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_1(), device = "png")})
...
output$downloadButton_2_1_2_2 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_2(), device = "png")})
...
output$downloadButton_2_1_2_3 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_3(), device = "png")})
...
output$downloadButton_2_1_2_4 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_4(), device = "png")})
...
output$downloadButton_2_1_2_5 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_5(), device = "png")})
...
output$downloadButton_2_1_2_6 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_6(), device = "png")})
...
output$downloadButton_2_1_2_7 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_7(), device = "png")})
...
output$downloadButton_2_1_2_8 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_8(), device = "png")})
...
output$downloadButton_2_1_2_9 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_9(), device = "png")})
...
output$downloadButton_2_1_2_10 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_10(), device = "png")})
...
output$downloadButton_2_1_2_11 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_11(), device = "png")})
...
#   content = function(file){ggplot2::ggsave(file, plot_2_1_12(), device = "png")})
...
output$downloadButton_2_1_2_13 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_13(), device = "png")})
...
output$downloadButton_2_1_2_14 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_14(), device = "png")})
...
output$downloadButton_2_1_2_15 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_15(), device = "png")})
...
output$downloadButton_2_1_2_16 <- shiny::downloadHandler(
  ...
  content = function(file){ggplot2::ggsave(file, plot_2_1_16(), device = "png")})